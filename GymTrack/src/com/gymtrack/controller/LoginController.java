...
public class LoginController implements Initializable {
    ...
    @FXML private TextField        passwordVisible;   // eye
    ...
    private void handleLogin() {
        ...
        // Saving user so other controllers can access it
        
        SessionManager.setCurrentUser(user);

        // Navigate to the correct dash board
    ...
    // Helping hand to show error messages
